...
/*
pop
1 = untuk menghapus array yang di belakang
-1 = untuk menghapus array yang di depan
*/
db.products.updateMany(
  {},
  {
  ...
  {},
  {
    $push: {
      ratings: {
        ...
        $slice: -5, // mines dari yang paling belakang
      },
    },
  }
);
...
db.products.updateMany(
  {},
  {
    $push: {
      ratings: {
        $each: [100, 200, 300, 400, 500],
        $slice: 3, // positif dari yang paling depan
      },
    },
  }
);
